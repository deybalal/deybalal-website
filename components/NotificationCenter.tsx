    ...
    <Popover>
      <PopoverTrigger asChild>
        ...
        >
          ...
          {unreadCount > 0 && (
            <span className="absolute top-1 end-1 w-4 h-4 bg-blue-500 text-white text-center text-[10px] font-bold rounded-full flex items-center justify-center border-2 border-background">
              {unreadCount}
            </span>
          )}
        </Button>
